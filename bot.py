...
async def approve(c, m):
    ...
    await c.send_photo(user_id, photo="https://mallucampaign.in/images/img_1707759373.jpg", await m.reply_text text=Config.start_text1.format(user.mention, m.chat.title), reply_markup=Config.movie_btn)
